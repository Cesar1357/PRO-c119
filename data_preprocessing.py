...
# Bueno no se si haci debe de funcionar pero ya no sabia que mas hacerle
...
def create_bot_corpus(words, classes):
    ...
    # print(pattern_word_tags_list,stem_words)
    # Remover palabras duplicadas de stem_words
    print(stem_words,pattern_word_tags_list) 
